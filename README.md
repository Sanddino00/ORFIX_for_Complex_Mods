...
Please only run it in the folder of the broken mod not the generall mod folder because it will brak all mods. 
...
Also if you use Gimi get the latest ORFix and ORFixApi and delete the old ones https://github.com/leotorrez/LeoTools/tree/main/releases